...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            .setAuthor({
                name: `${config.bot.name} | ${Lang.trans(interaction, 'about.title')}`,
                iconURL: config.bot.icon,
            })
            .setDescription(
                Lang.trans(interaction, 'about.description', {
                    bot: config.bot.name,
            ...
            .addFields(
                ...
                {
                    name: Lang.trans(interaction, 'about.coffee_title'),
                    value:
                        Lang.trans(interaction, 'about.coffee_description', {
                            bot: config.bot.name,
                        }) +
                        '```' +
        ...
        const featureButton = new ActionRowBuilder().addComponents(
            new ButtonBuilder()
